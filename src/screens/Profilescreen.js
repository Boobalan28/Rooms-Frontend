...
export const MyOrders = () => {
  ...
  useEffect(async () => {
    try {
      setloading(true);
      const data = await (
        await axios.post("https://room-apis.herokuapp.com/Bookings/getuserbookings", {
  ...
  async function cancelBooking(bookingid , roomid){
    ...
    try {
      setloading(true);
      // eslint-disable-next-line
      const result = await axios.post('https://room-apis.herokuapp.com/Bookings/cancelbooking' , {bookingid:bookingid , userid:user._id , roomid:roomid});
      setloading(false);
